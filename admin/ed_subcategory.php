...
?>
<?php
if(($_POST['subcat']!="") and ($_POST['scname']!=""))
   {
		$query1=mysql_query("update subcategory  set subcategory='".$_POST['scname']."' where subcatid='".$_POST['subcat']."'");
		if(!$query1)
		 {
			 $result="fail";
		 }
...
?></b>
    <form method="post" action="ed_subcategory.php">
  ...
  <tr>
    ...
    <td width="166" id="scateg">
      <select name="catid" id="select1" style="width:140px;">
        ...
        <tr>
          <td colspan="2"><input type="submit" name="button" id="button" value=" Re Name Sub Category" /></td>
          </tr>
      </table>
    </form>
    </td>
