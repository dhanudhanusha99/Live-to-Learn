...
<?php
 if(isset($_POST['cid']))
   {
	   $qur=mysql_query("delete from  category  where catid='".$_POST['cid']."'");
	   if(!$qur)
	    {
			$result="fail";
		}
...
<b><?php
  if($result=="fail")
    {
		print("<p align='left'>Could Not Perform Delete Operation.</p>");
	}
	  if($result=="ok")
    {
    ...
    <form method="post" action="del_category.php">
      <table width="283" border="1" cellpadding="0" cellspacing="0">
	   ...
	   ?>
        ...
        <tr>
          <td colspan="2"><input type="submit" name="button" id="button" value="Delete" /></td>
        </tr>
        <tr> </tr>
        <tr> </tr>
      </table>
